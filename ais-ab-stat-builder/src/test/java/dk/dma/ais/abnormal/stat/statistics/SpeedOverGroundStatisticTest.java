...
public class SpeedOverGroundStatisticTest {
    ...
    public void beforeTest() {
        ...
        assertEquals(4, Categorizer.mapSpeedOverGroundToCategory(track.getSpeedOverGround()));
    }
    ...
    public void testExistingShipCountIsUpdated() {
        ...
        existingStatisticData.setValue(3 - 1 /* -1 because idx counts from zero */, 3 - 1 /* -1 because idx counts from zero */, 4 - 1 /* -1 because idx counts from zero */, SpeedOverGroundStatisticData.STAT_SHIP_COUNT, 1);
