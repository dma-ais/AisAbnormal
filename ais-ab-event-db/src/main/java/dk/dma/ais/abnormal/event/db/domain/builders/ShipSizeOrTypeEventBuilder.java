 ...
 */
public class ShipSizeOrTypeEventBuilder extends EventBuilder {

    ShipSizeOrTypeEvent event;

    public ShipSizeOrTypeEventBuilder() {
        event = new ShipSizeOrTypeEvent();
    }

    public static ShipSizeOrTypeEventBuilder ShipSizeOrTypeEvent() {
        return new ShipSizeOrTypeEventBuilder();
    }
