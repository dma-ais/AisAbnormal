    ...
    private String generateReportBody(Date date0, Date date1, Multimap<Class<? extends Event>, Event> eventsByType) {
        ...
        eventsByType.keySet().forEach(eventType -> {
            ...
            eventsByType.get(eventType).forEach(event -> {
                ...
                email.append(String.format("%3d ", vessel.getLength() == null ? "" : vessel.getLength()));
                ...
                email.append(String.format("%7.4f ", tp.getLatitude() == null ? "" : tp.getLatitude()));
                email.append(String.format("%7.4f ", tp.getLongitude() == null ? "" : tp.getLongitude()));
                email.append(String.format("%4.1f ", tp.getSpeedOverGround() == null ? "" : tp.getSpeedOverGround()));
                email.append(String.format("%5.1f ", tp.getCourseOverGround() == null ? "" : tp.getCourseOverGround()));
                email.append(String.format("%3.0f ", tp.getTrueHeading() == null ? "" : tp.getTrueHeading()));
                email.append('\n');
            });
            email.append("======================================================================================================================\n");
            email.append("\n");
