...
public final class Configuration {
    ...
    public static final String CONFKEY_APPL_GRID_RESOLUTION_DEFAULT = "application.grid.resolution.default";
    ...
    public static final String CONFKEY_ANALYSIS_COG_ENABLED = "analysis.cog.enabled";
    ...
    public static final String CONFKEY_ANALYSIS_SOG_ENABLED = "analysis.sog.enabled";
    ...
    public static final String CONFKEY_ANALYSIS_TYPESIZE_ENABLED = "analysis.typesize.enabled";
    ...
    public static final String CONFKEY_ANALYSIS_DRIFT_ENABLED = "analysis.drift.enabled";
    ...
    public static final String CONFKEY_ANALYSIS_SUDDENSPEEDCHANGE_ENABLED = "analysis.suddenspeedchange.enabled";
    ...
    public static final String CONFKEY_ANALYSIS_CLOSEENCOUNTER_ENABLED = "analysis.closeencounter.enabled";
    ...
    public static final String CONFKEY_ANALYSIS_FREEFLOW_ENABLED = "analysis.freeflow.enabled";
